...

{
  ...
  mkHome = { username ? "corg", hostname ? "nixos", isWorkstation ? false, platform ? "x86_64-linux" }:
  ...
  mkHost = { hostname ? "nixos", username ? "corg", isWorkstation ? false, platform ? "x86_64-linux" }:
