...
let
  ...
  monitorsSettings = 
    ...
    else if hostname == "legioner" then ["eDP-1,1920x1080@60,0x0,1" "HDMI-A-2,1920x1080@71,1920x312,1"]
    else [];
  ...
  workspacesSettings = 
    ...
    else if hostname == "legioner" then 
      [
        ...
        "12, monitor:HDMI-A-2, default:true"
      ]  
